...
class PersonSeeder extends Seeder
{
    ...
    public function run(): void
    {
       ...
       Person::create([
            ...
            "gender" => "male",
            "is_legal" => false,
            "national_code" => config('secret.admin_national_code'),
            "mobile_number" =>  config('secret.admin_mobile_number'),
            "email" => config('secret.admin_email'),
